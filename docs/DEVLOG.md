...
Bumped the test runner three majors in a single jump. All 331 cases run unchanged on vitest 4.1.5; no test files needed edits. Audit went from 4 moderate vulnerabilities to 0 in the process.
