...
| `specs/emit-pass.md` | The emit phase's value target: the reading order, the receiver proof and runtime dispatch, operand shapes, the checks, the acceptance gate |
