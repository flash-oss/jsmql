...
src/
  ...
  compiler/       The five phases over the registry: lex/ → parse/ → passes/ (fold, desugar, position, shape, inject) → emit/ (lower, filter, statement, join, union, update, reduce-wrap, env, check, select, consult). See src/compiler/CLAUDE.md.
docs/
